...
${OBJECTDIR}/src/camera/VideoCapture.o: src/camera/VideoCapture.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/camera/VideoCapture.o src/camera/VideoCapture.cpp

${OBJECTDIR}/src/window/SimpleTextWindow.o: src/window/SimpleTextWindow.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/window
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/window/SimpleTextWindow.o src/window/SimpleTextWindow.cpp
